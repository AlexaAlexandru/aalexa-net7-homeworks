...
{
	internal class DataStructuresH
	{
		public void Go()
		{
            	//Point 2
		    ...
		    bool condition2 = (a >= 0 && rest2 == 0);

		    if (condition1 == true)
		    {
			Console.WriteLine("The top of the queuee is a positive number and multiple of 3 ");
		    }
		    else
		    {
			...
			if (condition2 == true)
			{
			    Console.WriteLine("The top of the queuee is a positive number and multiple of 7 ");
			}
			else
			{
			    e.Dequeue();
